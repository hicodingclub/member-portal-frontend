...
const mfileSubPath = [
    {path: 'list', component: MfileListSubComponent}
];


const mfilegroupDetailPath = [

    {path: 'mfile', children: mfileSubPath,
        data: {'mraLevel': 2, 'item': 'mfile'}},
];
...
export const mfilegroupRoutingPath = [
    {path: 'list', component: MfilegroupListComponent, canActivate: [AuthGuard]},
     {path: 'detail/:id', component: MfilegroupDetailComponent, children: mfilegroupDetailPath, canActivate: [AuthGuard]},
    {path: 'edit/:id', component: MfilegroupEditComponent, canActivate: [AuthGuard]},
    {path: 'new', component: MfilegroupEditComponent, canActivate: [AuthGuard]},
