...
import { LeadEditCustComponent } from '../../../membership-cust/base/lead/lead-edit.cust.component';
...
@Directive({
  ...
  providers: [{provide: NG_VALIDATORS, useExisting: MembershipLeadDirectiveEmail, multi: true}]
})
    ...
    if (typeof value == 'string') {
        for (let idx = 0; idx < this.validators.length; idx ++) {
            ...
            try {
                ...
                if (result == false ) return { 'membershipLeadDirectiveEmail': obj.msg };
            } catch (e) {
                return { 'membershipLeadDirectiveEmail': obj.msg };
            }
        }
    }
    return null;
