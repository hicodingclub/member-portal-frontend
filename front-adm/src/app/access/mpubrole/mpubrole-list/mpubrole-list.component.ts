...
@Component({
  selector: 'app-mpubrole-list',
  templateUrl: './mpubrole-list.component.html',
  styleUrls: ['./mpubrole-list.component.css']
})
export class MpubroleListComponent extends MpubroleListCustComponent implements OnInit {
  ...
  static getInstance() {
    ...
    return new MpubroleListComponent(null, null, null, null, null);
  }
}