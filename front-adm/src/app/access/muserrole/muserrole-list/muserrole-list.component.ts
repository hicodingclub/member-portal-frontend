...
export class MuserroleListComponent extends MuserroleListCustComponent implements OnInit {
  ...
  static getInstance() {
    ...
    return new MuserroleListComponent(null, null, null, null, null, null);
  }
}