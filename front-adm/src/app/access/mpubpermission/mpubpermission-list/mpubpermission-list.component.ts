...
@Component({
  selector: 'app-mpubpermission-list',
  templateUrl: './mpubpermission-list.component.html',
  styleUrls: ['./mpubpermission-list.component.css']
})
export class MpubpermissionListComponent extends MpubpermissionListCustComponent implements OnInit {
  ...
  constructor(public componentFactoryResolver: ComponentFactoryResolver, public mpubpermissionService: MpubpermissionService, public injector: Injector, public router: Router, public route: ActivatedRoute, public location: Location) {
    super(componentFactoryResolver, mpubpermissionService, injector, router, route, location);
  ...
  static getInstance() {
    ...
    return new MpubpermissionListComponent(null, null, null, null, null, null);
  }
}